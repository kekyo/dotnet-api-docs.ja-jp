### <a name="eventsourcewriteevent-impls-must-pass-writeevent-the-same-parameters-that-it-received-plus-id"></a>同じ受け取ったパラメーター (と ID)、EventSource.WriteEvent impls が WriteEvent を渡す必要があります。
