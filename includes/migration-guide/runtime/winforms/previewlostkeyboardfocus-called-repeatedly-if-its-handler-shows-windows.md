### <a name="previewlostkeyboardfocus-is-called-repeatedly-if-its-handler-shows-a-windows-forms-message-box"></a>そのハンドラーは、Windows フォーム メッセージ ボックスを表示されている場合、PreviewLostKeyboardFocus が繰り返し呼び出されます
